console.log('storeController.js se cargó correctamente');
...
exports.createStore = async (req, res) => {
  try {
    ...
    if (!req.files || req.files.length === 0) {
      return res.status(400).json({ msg: 'Al menos una imagen es requerida' });
    }
    ...
    console.error('Error en createStore:', err);
